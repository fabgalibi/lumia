...
export default function PreparationTypeCard({ 
  ...
  return (
    <BaseCard
      ...
      width={screenSize === 'mobile' ? '100%' : '660px'} // card mais largo: 660px
      grids={[{ 
        position: 'right', 
        top: '-105.6px',  // y: -105.6px conforme Figma
        leftPosition: screenSize === 'mobile' ? '120px' : '370px' // x: 370px conforme Figma (usar left para posição absoluta)
      }]}
