...
export const ContinueWatchingCarousel: React.FC<ContinueWatchingCarouselProps> = ({ className = '' }) => {
    ...
    },
    {
      ...
      const getCardsPerView = () => {
        if (typeof window !== 'undefined') {
          ...
          // Considerando padding lateral de 32px (16px cada lado)
          const availableWidth = width - 32; // 32px de padding lateral
          const cardWidth = 249 + 20; // 249px card + 20px gap
        ...
        return 2; // Default - mostrar pelo menos 2 cards no mobile
      };
            ...
            >
              <button 
                ...
                style={{
                  ...
                  width: '32px',
                  height: '32px',
                  background: currentIndex === 0 ? 'rgba(45, 45, 69, 1)' : 'rgba(45, 45, 69, 1)',
                  border: 'none',
                  borderRadius: '6px',
                  padding: '6px',
            ...
            >
              ...
              <button 
                ...
                style={{
                  ...
                  width: '32px',
                  height: '32px',
                  background: currentIndex >= maxIndex ? 'rgba(45, 45, 69, 1)' : 'rgba(45, 45, 69, 1)',
                  border: 'none',
                  borderRadius: '6px',
                  padding: '6px',
