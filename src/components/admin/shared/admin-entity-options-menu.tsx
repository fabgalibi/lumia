...
interface AdminEntityOptionsMenuProps {
  onEdit?: () => void;
  onAddSubjects?: () => void;
  onDuplicate?: () => void;
  onDelete?: () => void;
...
export const AdminEntityOptionsMenu: React.FC<AdminEntityOptionsMenuProps> = ({
  onEdit,
  onAddSubjects,
  onDuplicate,
  onDelete,
    ...
    <div style={{ position: 'relative' }}>
      ...
      {isOpen && (
        ...
        >
          ...
          {/* Divisor */}
          {onEdit && (onAddSubjects || onDuplicate || onDelete) && (
            <div style={{
              height: '1px',
          ...
          {/* Divisor */}
          {onAddSubjects && (onDuplicate || onDelete) && (
            <div style={{
              height: '1px',
              backgroundColor: '#373A41',
              margin: '4px 0px'
